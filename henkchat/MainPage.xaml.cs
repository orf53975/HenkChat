...
namespace HenkChat
{
    public sealed partial class MainPage : Page
    {
        ...
        private void _Connect(object sender, RoutedEventArgs e)
        {
            ...
            if (x.Equals(0)) { _ShowPopup("Could not connect to NameServer"); return; }
            else if (x.Equals(1)) { _ShowPopup("Server does not exists"); return; }
            else if (x.Equals(2)) { _ShowPopup("Could not connect to server"); return; }
